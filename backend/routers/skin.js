...
skinRouter.post('/create', auth.authenAdmin, upload.single('avatar'), skinController.create);
skinRouter.put('/update', auth.authenAdmin, upload.single('avatar'), skinController.update);
